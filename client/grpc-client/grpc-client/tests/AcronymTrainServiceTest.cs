...
{
    private readonly services.AcronymTrainDataServiceService _service;

    public AcronymTrainDataServiceTest()
    {
        _service = new services.AcronymTrainDataServiceService();
    }
    ...
    {
        // Arrange
        var model = new AcronymTrainData
        {
            ProvidedBy = "User",
            TextEn = "TermEn",
            TextFr = "TermFr",
    ...
    public async Task c_Update()
    {
        ...
        Assert.Equal(last.Reason, updated.Reason);
    }
